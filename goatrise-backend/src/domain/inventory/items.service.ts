...
import { items, type ItemAttributeValues } from "../../db/schema/items.schema.js";
...
import { areAttributeValuesValidForRequired, getProductById } from "../catalog/products.service.js";
